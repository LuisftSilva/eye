(()=>{
  ...
  function candidates(camera){
    ...
    for(const token of values){
      urls.push(`https://video-auth1.iol.pt/auth-beachcam/${token}/playlist.m3u8`);
      urls.push(`https://video-auth1.iol.pt/beachcam/${token}/playlist.m3u8`);
    }
    return [...new Set(urls)];
  }
