...
["hotel-oslo-coimbra-panorama","Coimbra - Vista panorâmica do Hotel Oslo","Coimbra","Coimbra",40.2094,-8.4317,"city","http://www.hoteloslo-coimbra.pt/coimbra/tempo-em-coimbra/"]
].map(([id,name,city,region,lat,lng,category,sourceUrl])=>({id,name,city,region,country:"Portugal",lat,lng,category,status:"unknown",provider:id.startsWith("hotel-oslo-")?"Hotel Oslo Coimbra":"WorldCam Directory",sourceUrl,embedUrl:"",description:id.startsWith("hotel-oslo-")?"Vista panorâmica sobre a zona histórica de Coimbra a partir do terraço do Hotel Oslo Coimbra.":"Entrada portuguesa identificada no diretório WorldCam. Abrir a fonte para consultar a transmissão original e o respetivo operador.",verifiedAt:"2026-08-02",verification:id.startsWith("hotel-oslo-")?"provider-page":"directory-listing",uniqueFeed:id.startsWith("hotel-oslo-"),tags:[region,city,category,id.startsWith("hotel-oslo-")?"Hotel Oslo Coimbra":"WorldCam"]}));
