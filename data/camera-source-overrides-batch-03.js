(()=>{
  ...
  const patches=new Map(Object.entries({
    ...
    "madeira santa cruz canico praia dos reis magos":{provider:"WorldCam specific",sourceUrl:"https://worldcam.eu/webcams/europe/portugal/madeira",status:"online",verification:"specific-region-page"},
    "madeira sao vicente faja da areia":{provider:"WorldCam specific",sourceUrl:"https://worldcam.eu/webcams/europe/portugal/madeira",status:"online",verification:"specific-region-page"},
    ...
    "sagres praia":{provider:"WorldCam specific",sourceUrl:"https://worldcam.eu/webcams/europe/portugal/faro",status:"online",verification:"specific-region-page"}
  }));
