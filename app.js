...
const map=new maplibregl.Map({container:"map",style:satelliteStyle,center:[-12.5,38.5],zoom:3.2,pitch:0,attributionControl:true,antialias:true,maxZoom:19});
